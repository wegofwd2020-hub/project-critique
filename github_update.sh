...
# wegofwd-private-docs, and atri-sangam are code/docs-only, so they appear here but
# not in MEM_PATHS below.
PROJECTS="StudyBuddy_OnDemand studybuddy-docs Mentible thittam thittam_docs mambakkam-net pramana kathai-chithiram project-critique wegofwd-private-docs MarketingTools wegofwd-llm wegofwd-orchestration wegofwd-video wegofwd-expenses wegofwd-secure dronePrjs medtracker atri-sangam"
