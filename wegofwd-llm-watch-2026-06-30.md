# wegofwd-llm — Watch Report 2026-06-30
...
**Current HEAD:** `3b08f44` (`3b08f4422ee003ee764303161b5c4ce9d236216a`)
**Commit count in window:** 10
**Current test count:** 56 `def test_` across `tests/`
**Current source LOC:** 937 (excl. `__init__.py`)
...
```
3b08f44 Merge pull request #4 from wegofwd2020-hub/feat/add-zai-provider
389d535 feat(registry): add z.ai (GLM) as a BYOK OpenAI-compatible provider
...
```
 ...
 wegofwd_llm/registry.py               |  19 ++++
 wegofwd_llm/trust.py                  | 174 ++++++++++++++++++++++++++++++++++
 12 files changed, 534 insertions(+), 9 deletions(-)
```
...
Merging this PR advances `wegofwd-llm-last-reviewed.txt` to `3b08f4422ee003ee764303161b5c4ce9d236216a` — the next weekly watch will measure from this commit forward.
