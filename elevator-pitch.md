...
Most recently I've been doing something unusual for an architect — I took two domain
...
Over the past year I've taken that same discipline and applied it to two products I
...
away. Over the past year I have designed and built two production-grade SaaS platforms
...
| "Do they just draw diagrams or do they own outcomes?" | Conceived two products, wrote the problem statements, built them to production quality — no team, no budget, no excuses |
| "Will they raise our standards or just fit in?" | 17 non-negotiable engineering rules written before a line of code. ADRs. Separate docs repos. FERPA in the database layer, not the application layer |
